...
const DashboardTurista = () => {
  ...
  const consultarHistorial = useCallback(async () => {
    ...
    try {
      const response = await fetch("https://tourmatchterminar-2.onrender.com/api/reservas/mis-reservas", { 
        method: "GET",
  ...
  const handleSolicitarViaje = async () => {
    ...
    try {
      const response = await fetch("https://tourmatchterminar-2.onrender.com/api/reservas/crear", { 
        method: "POST",
