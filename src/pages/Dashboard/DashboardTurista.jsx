...
const DashboardTurista = () => {
  ...
  const consultarHistorial = useCallback(async () => {
    ...
    try {
      const response = await fetch("https://tourmatchterminar-1.onrender.com://tourmatchterminar-1.https://tourmatchterminar-1.onrender.com.onrender.com/api/reservas/mis-reservas", { 
        method: "GET",
