...
const RegistrarVehiculo = ({ onRegistroExitoso }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://tourmatchterminar-1.onrender.com://tourmatchterminar-1.https://tourmatchterminar-1.onrender.com.onrender.com/api/vehiculos/registrar", {
        method: "POST",
        headers: {
